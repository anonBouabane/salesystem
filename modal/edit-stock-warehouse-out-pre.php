...
select  sum(item_values) as item_count,item_name,apo_id,wh_id
from tbl_stock_out_warehouse_detail_pre a
left join tbl_item_data b on a.item_id = b.item_id
where add_by = '$id_users' and a.item_id ='$id'
group by a.item_id,apo_id,wh_id
...
<fieldset style="width:543px;">
    ...
    <div class="col-md-12 mt-4">
        <form method="post" id="updatestockoutpre">
