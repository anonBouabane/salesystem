...
if ($wh_id == 0) {
    ...
    $countrow = $conn->query(" SELECT count(*)+1 as last_number 
    ...
    $insertDSS = $conn->query(" insert into tbl_stock_in_warehouse  (siw_bill_number,bill_type,br_id,wh_id,add_by,date_register) 
    values ('$ref_bill','1','$br_id','$wh_id','$id_users',CURDATE()); ");
