                            ...
                            <div class="    ">
                                <div class="  p-4 p-xl-5">
                                    ...
                                    <form method="post" id="additemorderfrm">
                                        ...
                                        <?php
                                        $rowod = $conn->query("
                                        select a.or_id,a.br_id,a.wh_id,(case when apo_id is null then 0 else apo_id end) as apo_id,
                                        or_bill_number,br_name,full_name
                                        from tbl_order_request a
                                        left join tbl_approve_order b on a.or_id = b.or_id
                                        left join tbl_branch c on a.br_id = c.br_id
                                        left join tbl_user d on a.add_by = d.add_by
                                        ...
                                        <div class="card p-4">
                                            ...
                                            <div class="row   no-gutters justify-content-center">
                                                ...
                                                <div class="col-lg-6 text-center ">
                                                    <div class="form-group">
                                                        <label for="firstName">
                                                            <h3> ຜູ້ຂໍ: <?php echo $rowod['full_name']; ?> </h3>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 text-center ">
                                                    <div class="form-group">
                                                        <label for="firstName">
                                                            <h3> ສາຂາ: <?php echo $rowod['br_name']; ?> </h3>
                                                        </label>
                                                    </div>
                                                </div>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="form-group "> <?php echo "ລາຍການທີ: $x"; ?> <br>
                                                                                            <div class="row p-2">
                                                                                                ...
                                                                                                <div class="col-lg-2">
                                                                                                    <div class="form-group">
                                                                                                        <label for="firstName">ອານຸຍາດ</label>
