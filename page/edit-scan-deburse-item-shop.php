                                        ...
                                        <div class="row">
                                            ...
                                            <form method="post" class="contact-form card-header px-0  text-center"
                                                ...
                                                <input type="hidden" id="warehouse_id" name="warehouse_id"
                                                    class="form-control" autofocus value='<?php echo "$wh_id" ?>'>
                            ...
                            <form method="post" id="submittrack">
                                ...
                                <div class="card card-default chat-right-sidebar text-center" style="height: 100%;">
                                    ...
                                    <input type="hidden" id="warehouse_id" name="warehouse_id" class="form-control"
                                        autofocus value='<?php echo  $rowedit["wh_id"]; ?>'>

                                    <input type="hidden" id="dips_id" name="dips_id" class="form-control" autofocus
                                        value='<?php echo "$dips_id" ?>'>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input type="hidden" name="item_name[]"
                                                            ...
                                                            value='<?php echo "$item_name"; ?>' class="form-control">
                                                        <input type="hidden" name="item_name[]"
                                                            id="item_name<?php echo $x; ?>"
                                                            value='<?php echo "$item_name"; ?>' class="form-control">
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right"
                                                                    ...
                                                                    <a rel="facebox"
                                                                        href="../modal/edit-item-deburse-shop-detail.php?id=<?php echo $row4['sowd_id']; ?>"
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right"
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="edit-scan-deburse-item-shop.php?sow_id=<?php echo $row4['sow_id']; ?>">ແກ້ໄຂ</a>
