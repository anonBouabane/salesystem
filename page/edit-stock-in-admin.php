                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="row">
                                            ...
                                            <form method="post" class="contact-form card-header px-0  text-center"
                                                ...
                                                <input type="hidden" name="siw_id" id="siw_id"
                                                    value='<?php echo "$siw_id"; ?>' class="form-control">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="" class="table table-hover table-product" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    where siw_id='$siw_id' 
                                                    group by item_name,a.item_id,siwd_id
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right"
                                                                    ...
                                                                    <a rel="facebox"
                                                                        href="../modal/edit-stock-in-admin-detail.php?id=<?php echo $row4['siwd_id']; ?>"
                                                                        class="dropdown-item">ແກ້ໄຂ</a>

                                                                    <a class="dropdown-item" type="button"
                                                                        id="delstockinpre"
                                                                        data-id='<?php echo $row4['siwd_id']; ?>'
